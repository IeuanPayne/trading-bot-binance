...
MT5_STAGED_EXIT_ENABLED = _as_bool(os.getenv("MT5_STAGED_EXIT_ENABLED", "False"), default=False)
MT5_STAGED_BE_TRIGGER_PIPS = _as_float(os.getenv("MT5_STAGED_BE_TRIGGER_PIPS"), default=30.0)
MT5_STAGED_BE_OFFSET_PIPS = _as_float(os.getenv("MT5_STAGED_BE_OFFSET_PIPS"), default=5.0)
MT5_STAGED_TRAIL_PIPS = _as_float(os.getenv("MT5_STAGED_TRAIL_PIPS"), default=50.0)
MT5_STAGED_TP4_OPEN = _as_bool(os.getenv("MT5_STAGED_TP4_OPEN", "False"), default=False)
...
MT5_LOT_PER_500_BALANCE = _as_float(os.getenv("MT5_LOT_PER_500_BALANCE"), default=0.0)
